...
pdf.set_title(title)
pdf.add_page()
pdf.cell(0, 5, f'Pfosten-Riegel Fertigung ({totals[arbeitsbereiche[0]]} / {100*26} Std.)', align='L')
pdf.image(f'grafiken/Grafik_PR-Fertigung_KW{kw}.png', x=50, y=25, w=200, h=72)
pdf.ln(85)
pdf.cell(0, 5, f'Fenster Fertigung ({totals[arbeitsbereiche[1]]} / {400*26} Std.)', align='L')
pdf.image(f'grafiken/Grafik_Fensterfertigung_KW{kw}.png', x=50, y=115, w=200, h=72)
pdf.add_page()
pdf.cell(0, 5, f'Türen Fertigung ({totals[arbeitsbereiche[2]]} / {180*26} Std.)', align='L')
pdf.image(f'grafiken/Grafik_Türfertigung_KW{kw}.png', x=50, y=25, w=200, h=72)
pdf.ln(85)
pdf.cell(0, 5, f'Blech Fertigung ({totals[arbeitsbereiche[3]]} / {50*26} Std.)', align='L')
pdf.image(f'grafiken/Grafik_Blechfertigung_KW{kw}.png', x=50, y=115, w=200, h=72)
pdf.add_page()
pdf.cell(0, 5, f'Schweissen Fertigung ({totals[arbeitsbereiche[4]]} / {80*26} Std.)', align='L')
pdf.image(f'grafiken/Grafik_Schweissen_KW{kw}.png', x=50, y=25, w=200, h=72)
pdf.ln(85)
pdf.cell(0, 5, f'Rollen Fertigung ({totals[arbeitsbereiche[5]]} / {40*26} Std.)', align='L')
