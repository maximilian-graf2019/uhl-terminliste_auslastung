...
pdf.set_title(title)
pdf.add_page()
pdf.cell(0, 5, f'Pfosten-Riegel Fertigung (Ist:{totals[arbeitsbereiche[0]]} / Soll:{100*26} Std.)', align='L')
pdf.image(f'grafiken/Grafik_PR-Fertigung_KW{kw}.png', x=50, y=25, w=200, h=72)
pdf.ln(85)
pdf.cell(0, 5, f'Fenster Fertigung (Ist:{totals[arbeitsbereiche[1]]} / Soll:{400*26} Std.)', align='L')
pdf.image(f'grafiken/Grafik_Fensterfertigung_KW{kw}.png', x=50, y=115, w=200, h=72)
pdf.add_page()
pdf.cell(0, 5, f'Türen Fertigung (Ist:{totals[arbeitsbereiche[2]]} / Soll:{180*26} Std.)', align='L')
pdf.image(f'grafiken/Grafik_Türfertigung_KW{kw}.png', x=50, y=25, w=200, h=72)
pdf.ln(85)
pdf.cell(0, 5, f'Blech Fertigung (Ist:{totals[arbeitsbereiche[3]]} / Soll:{50*26} Std.)', align='L')
pdf.image(f'grafiken/Grafik_Blechfertigung_KW{kw}.png', x=50, y=115, w=200, h=72)
pdf.add_page()
pdf.cell(0, 5, f'Schweissen Fertigung (Ist:{totals[arbeitsbereiche[4]]} / Soll:{80*26} Std.)', align='L')
pdf.image(f'grafiken/Grafik_Schweissen_KW{kw}.png', x=50, y=25, w=200, h=72)
pdf.ln(85)
pdf.cell(0, 5, f'Rollen Fertigung (Ist:{totals[arbeitsbereiche[5]]} / Soll:{40*26} Std.)', align='L')
